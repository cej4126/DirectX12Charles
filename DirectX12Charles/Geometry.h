...
public:
   template<class V>
   static Geometry<V> MakeConeTesselated(int longDiv)
   {
      assert(longDiv >= 3);
   ...
   template<class V>
   static Geometry<V> MakeCone()
   {
      return MakeConeTesselated<V>(24);
   }

   template<class V>
   static Geometry<V> MakeCube()
   {
      constexpr float side = 1.0f;
   ...
   template<class V>
   static Geometry<V> MakePlaneTesselated(int divisions_x, int divisions_y)
   {
      assert(divisions_x >= 1);
      assert(divisions_y >= 1);
   ...
   template<class V>
   static Geometry<V> MakePlane()
   {
      return MakePlaneTesselated<V>(1, 1);
   }

   template<class V>
   static Geometry<V> MakeCylinderTesselated(int longDiv)
   {
      assert(longDiv >= 3);
   ...
   template<class V>
   static Geometry<V> MakeCylinder()
   {
      return MakeCylinderTesselated<V>(24);
   }

   template<class V>
   static Geometry<V> MakeSphereTesselated(int latDiv, int longDiv)
   {
      assert(latDiv >= 3);
      assert(longDiv >= 3);
   ...
   template<class V>
   static Geometry<V> MakeSphere()
   {
      return MakeSphereTesselated<V>(12, 24);
   }
